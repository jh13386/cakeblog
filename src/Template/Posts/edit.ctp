<div class="index large-8 large-offset-2 columns">
	<div class="panel">
		...
		<?php
			...
			echo $this->Form->control('title', array('value' => $post['title']));
			echo $this->Form->control('body', array('value' => $post['body'], 'rows'=> '5'));
			echo $this->Form->control('tags', array('value' => $post['tags']));
